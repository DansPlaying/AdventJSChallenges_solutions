...
function distributeGifts(packOfGifts, reindeers) {
	let totalGiftWeight = packOfGifts.join('').length
	let totalReindeerCapability = reindeers.join('').length * 2
	
	const totalPacks = Math.floor(totalReindeerCapability / totalGiftWeight)
	return totalPacks
  }
